...
async function main() {
  ...
  // ── 10. Live today ────────────────────────────────────────────────────
  {
    ...
    const stack = [
      ...
      ['Tests', '85 contract + 14 Lens projection + 16 relay tests, all passing'],
    ];
    let y = 2.15;
    stack.forEach(([h, b]) => {
    ...
    s.addText('dokett-console.vercel.app', { x: MARGIN + 0.3, y: 5.72, w: 5, h: 0.35, fontFace: MONO, fontSize: 13, color: PAPER, margin: 0 });
